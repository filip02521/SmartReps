      ...
      <HomeSection title={pl.homeActivityTitle}>
        ...
        {sessions.some((s) => s.status === 'completed') && (
          <button
            ...
            className={cn(
              FOCUS_RING,
              'group mt-4 flex w-full items-center gap-2 rounded-[var(--sr-radius-md)] border border-[var(--sr-border-subtle)] bg-[var(--sr-bg-surface)] p-3 text-left transition-colors hover:bg-[var(--sr-bg-elevated)]',
            )}
          >
