...
export const squatCycles: Cycle[] = [
  ...
  // L1 — 1-20 przysiadów (5 serii, 60s rest)
  {
    ...
    days: standard6DaySquat([
      { reps: [4, 5, 7, 7], maxMin: 7 },
      { reps: [6, 7, 6, 7], maxMin: 8 },
      { reps: [7, 7, 7, 7], maxMin: 8 },
      { reps: [8, 7, 8, 7], maxMin: 8 },
      { reps: [7, 8, 7, 8], maxMin: 10 },
  ...
  // L2 — 21-40 przysiadów (5 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 3],
    days: standard6DaySquat([
      { reps: [8, 8, 9, 9], maxMin: 10 },
      { reps: [9, 9, 10, 10], maxMin: 10 },
      { reps: [10, 11, 11, 12], maxMin: 12 },
      { reps: [12, 12, 12, 12], maxMin: 12 },
      { reps: [13, 13, 14, 14], maxMin: 16 },
      { reps: [14, 14, 14, 14], maxMin: 16 },
    ]),
  },
  ...
  // L3 — 41-60 przysiadów (5 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [16, 17, 16, 17], maxMin: 18 },
      { reps: [16, 16, 16, 16], maxMin: 18 },
      { reps: [17, 18, 17, 16], maxMin: 18 },
      { reps: [20, 19, 19, 19], maxMin: 22 },
      { reps: [21, 21, 19, 19], maxMin: 22 },
      { reps: [21, 21, 21, 21], maxMin: 24 },
    ]),
  },
  ...
  // L4 — 61-80 przysiadów (5 serii, 60s rest)
  {
    ...
    days: standard6DaySquat([
      ...
      { reps: [22, 22, 23, 23], maxMin: 24 },
      { reps: [23, 23, 23, 23], maxMin: 24 },
      { reps: [23, 23, 24, 24], maxMin: 26 },
      { reps: [24, 24, 24, 24], maxMin: 26 },
      { reps: [25, 25, 25, 25], maxMin: 28 },
    ]),
  },
  ...
  // L5 — 81-100 przysiadów (5 serii, 60s rest)
  {
    ...
    days: standard6DaySquat([
      ...
      { reps: [26, 26, 27, 27], maxMin: 28 },
      { reps: [27, 27, 27, 27], maxMin: 30 },
      { reps: [28, 28, 28, 28], maxMin: 30 },
      { reps: [29, 29, 29, 29], maxMin: 30 },
      { reps: [29, 30, 29, 30], maxMin: 32 },
    ]),
  },
  ...
  // L6 — 101-125 przysiadów (5 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [31, 31, 31, 31], maxMin: 32 },
      { reps: [32, 32, 32, 32], maxMin: 34 },
      { reps: [33, 33, 33, 33], maxMin: 36 },
      { reps: [34, 35, 35, 34], maxMin: 36 },
      { reps: [35, 35, 35, 35], maxMin: 36 },
      { reps: [35, 36, 36, 35], maxMin: 38 },
    ]),
  },
  ...
  // L7 — 126-150 przysiadów (5 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [37, 38, 37, 38], maxMin: 40 },
      { reps: [38, 39, 39, 38], maxMin: 40 },
      { reps: [39, 39, 39, 39], maxMin: 42 },
      { reps: [40, 41, 41, 40], maxMin: 42 },
      { reps: [41, 41, 41, 41], maxMin: 42 },
      { reps: [41, 41, 41, 41], maxMin: 46 },
    ]),
  },
  ...
  // L8 — 151-175 przysiadów (5 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [43, 43, 41, 41], maxMin: 46 },
      { reps: [44, 44, 46, 46], maxMin: 46 },
      { reps: [46, 46, 45, 45], maxMin: 46 },
      { reps: [46, 46, 45, 45], maxMin: 48 },
      { reps: [46, 46, 47, 47], maxMin: 48 },
      { reps: [47, 48, 47, 46], maxMin: 50 },
    ]),
  },

  // ═══════════════════════════════════════════════════════════════
  // ADVANCED (L9–L15): 176–300 przysiadów
  // Cykle L11+ mają 7 serii zamiast 5 — wyższa gęstość treningowa.
  // ═══════════════════════════════════════════════════════════════
  ...
  // L9 — 176-200 przysiadów (5 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [49, 49, 49, 49], maxMin: 50 },
      { reps: [49, 50, 50, 49], maxMin: 52 },
      { reps: [51, 51, 51, 51], maxMin: 52 },
      { reps: [51, 52, 52, 51], maxMin: 54 },
      { reps: [52, 53, 52, 53], maxMin: 56 },
      { reps: [52, 53, 53, 52], maxMin: 60 },
    ]),
  },
  ...
  // L10 — 201-220 przysiadów (5 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [52, 53, 53, 54], maxMin: 60 },
      { reps: [54, 54, 54, 54], maxMin: 60 },
      { reps: [55, 55, 55, 55], maxMin: 60 },
      { reps: [56, 56, 56, 56], maxMin: 60 },
      { reps: [57, 57, 57, 57], maxMin: 60 },
      { reps: [57, 58, 57, 58], maxMin: 62 },
    ]),
  },
  ...
  // L11 — 221-240 przysiadów (7 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [48, 42, 42, 42, 42, 42], maxMin: 44 },
      { reps: [50, 48, 42, 44, 42, 42], maxMin: 44 },
      { reps: [50, 48, 44, 42, 42, 42], maxMin: 50 },
      { reps: [52, 50, 44, 44, 44, 44], maxMin: 52 },
      { reps: [44, 46, 52, 50, 50, 50], maxMin: 54 },
      { reps: [46, 46, 52, 52, 48, 48], maxMin: 56 },
    ]),
  },
  ...
  // L12 — 241-260 przysiadów (7 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [50, 52, 50, 52, 50, 50], maxMin: 56 },
      { reps: [50, 52, 52, 52, 54, 52], maxMin: 56 },
      { reps: [54, 52, 52, 52, 50, 56], maxMin: 56 },
      { reps: [56, 54, 52, 52, 50, 56], maxMin: 58 },
      { reps: [58, 56, 52, 52, 52, 56], maxMin: 58 },
      { reps: [58, 58, 52, 52, 54, 56], maxMin: 60 },
    ]),
  },
  ...
  // L13 — 261-275 przysiadów (7 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [60, 58, 52, 54, 52, 60], maxMin: 60 },
      { reps: [58, 56, 56, 58, 54, 60], maxMin: 60 },
      { reps: [60, 58, 58, 54, 56, 60], maxMin: 62 },
      { reps: [60, 58, 58, 58, 56, 62], maxMin: 62 },
      { reps: [60, 60, 58, 56, 58, 62], maxMin: 62 },
  ...
  // L14 — 276-290 przysiadów (7 serii, 60s rest)
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [64, 62, 62, 60, 60, 60], maxMin: 64 },
      { reps: [64, 64, 62, 62, 60, 60], maxMin: 64 },
      { reps: [64, 64, 64, 62, 60, 62], maxMin: 64 },
      { reps: [64, 64, 64, 64, 60, 62], maxMin: 66 },
  ...
  // L15 — 291-300 przysiadów (7 serii, 60s rest) — FINAŁ
  {
    ...
    estimatedWeeks: [2, 4],
    days: standard6DaySquat([
      { reps: [66, 66, 64, 66, 64, 64], maxMin: 68 },
      { reps: [68, 68, 64, 66, 66, 64], maxMin: 68 },
      { reps: [68, 68, 68, 66, 66, 64], maxMin: 68 },
