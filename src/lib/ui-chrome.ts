/** Chrome stacking — keep Toast above sheets, pill below sheets. */
export const Z_TAB_BAR = 40
export const Z_REST_PILL = 40
export const Z_REST_EXPANDED = 50
export const Z_SHEET = 55
export const Z_CELEBRATION = 70
