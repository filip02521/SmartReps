...
const plDict = {
  ...
  homeTipWelcomeTraining: 'Trening — karta programu poniżej. Zrób test max, wybierz cykl i rozpocznij.',
  homeTipWelcomeProgress: 'Postępy — historia treningów, osiągnięcia, analiza AI i trendy RPE.',
  homeTipWelcomePlans: 'Plany — własne plany, gotowe programy i społeczność.',
  homeTipWelcomeProfile: 'Profil — konto, synchronizacja, AI Coach i ustawienia.',
