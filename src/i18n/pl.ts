...
const plDict = {
  ...
  starterTemplateName_foundationBodyweight3d: 'Foundation Bodyweight',
  ...
  starterTemplateName_calisthenicsStrength4d: 'Calisthenics Strength',
  starterTemplateDesc_calisthenicsStrength4d: 'Push/Pull/Legs/Core split dla średniozaawansowanych. Hipertrofia i siła kalisteniczna, 4 dni w tygodniu.',
  starterTemplateName_pullupFoundations3d: 'Pullup Foundations',
  starterTemplateDesc_pullupFoundations3d: 'Droga do pierwszego podciągnięcia. Negatywy, assisted i akcesoria — 3 razy w tygodniu z progresją.',
  starterTemplateName_fullbodyDumbbell3d: 'Full Body Dumbbell',
  starterTemplateDesc_fullbodyDumbbell3d: 'Siła całego ciała z hantlami. Nauka wzorców z obciążeniem, 3 pełne sesje w tygodniu.',
  starterTemplateName_upperLowerBarbell4d: 'Upper/Lower Barbell',
  ...
  starterTemplateName_pushPullLegs6d: 'Push Pull Legs',
  ...
  starterTemplateName_coreConditioning3d: 'Core & Conditioning',
  starterTemplateDesc_coreConditioning3d: 'Mocny core (anti-rotation, anti-extension) + kondycja. McGill-based, 3 razy w tygodniu.',
  starterTemplateName_kettlebellPower3d: 'Kettlebell Power',
  ...
  challengeRepsLabel: 'Liczba powtórzeń',
  challengeRepsPlaceholder: 'Np. 85',
  challengeNewBest: 'Nowy rekord!',
  challengeNotBest: 'To nie jest Twój najlepszy wynik — zapisano poprzedni',
  challengeLoginRequired: 'Zaloguj się, aby wziąć udział',
  challengeNotActive: 'Wyzwanie nie jest już aktywne',
  challengeInvalidReps: 'Podaj poprawną liczbę powtórzeń',
  challengeLeaderboard: 'Ranking',
  challengeLeaderboardEmpty: 'Brak wyników — bądź pierwszy!',
  challengeRank: 'Miejsce',
  challengeRankPosition: (n: number) => `Miejsce ${n}`,
  challengeYourResult: 'Twój wynik',
  challengeAnonymous: 'Anonim',
  challengeYouLabel: 'Ty',
  challengeWeekKey: (week: string) => `Tydzień ${week}`,
  challengeProgressLabel: (current: number, target: number) => `${current} / ${target} powtórzeń`,
