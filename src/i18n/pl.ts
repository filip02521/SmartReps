export const pl = {
  ...
  customSummaryRecSuccess: 'Świetna robota. Zrób zaplanowaną przerwę — regeneracja buduje siłę.',
  customSummaryRecFail: 'Ten sam dzień czeka po przerwie. Możesz spróbować ponownie, gdy będziesz gotowy.',
  customSummaryFailPolicy: 'Po failu: 1 dzień przerwy, potem ponowna próba tego samego dnia.',
  ...
  customHomeEmptyHint: 'Włącz plany w Profilu → Moje plany na Home.',
  ...
  timerSoundHint: 'Koniec przerwy i zaliczenie serii',
  timerVibration: 'Wibracja',
  keepScreenOn: 'Nie gaś ekranu podczas treningu',
  keepScreenOnHint:
    'Gdy włączone, ekran pozostaje aktywny przez cały trening — serie, przerwy i timer (wymaga Wake Lock w przeglądarce / PWA).',
  ...
  progressMyExercises: 'Moje ćwiczenia',
