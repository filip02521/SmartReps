...
const plDict = {
  ...
  aiModelLabel: 'Model',
  aiModelHint: 'Najtańszy i najszybszy model wystarczy. Lepsze modele dają wyższą jakość.',
  ...
  aiProviderHintGemini: 'Klucz z aistudio.google.com. Gemini 2.5 Flash ma darmowy limit.',
