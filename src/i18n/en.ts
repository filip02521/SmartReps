...
export const en: Translation = {
  ...
  homeTipWelcomeTraining: 'Training — program card below. Do a max test, pick a cycle, and start.',
  homeTipWelcomeProgress: 'Progress — workout history, achievements, AI analysis and RPE trends.',
  homeTipWelcomePlans: 'Plans — custom plans, ready-made programs and community.',
  homeTipWelcomeProfile: 'Profile — account, sync, AI Coach and settings.',
