...
export const en: Translation = {
  ...
  onboardingWelcomeBody:
    'We\'ll guide you through ready-made pushup and pull-up cycles. You can also build your own training plans — for the gym, machines, or home workouts — or import a ready-made one from the catalog. Works offline — email OTP login, no Google or Facebook accounts.',
  ...
  onboardingNextTitle: 'What\'s next?',
  onboardingNextHome:
    'You\'ll land on the Training screen. We don\'t force anything — you choose when to start.',
  onboardingNextStrong:
    'You\'ll launch the program from the card on the Training screen. With two programs, do the tests separately and leave a break between them. You can also create a custom plan in the Plans tab.',
  onboardingNextCustom:
    'You\'ll add custom plans in the Plans tab or in the section on the Training screen.',
  ...
  aiModelLabel: 'Model',
  aiModelHint: 'The cheapest and fastest model is enough. Better models give higher quality.',
  ...
  aiProviderHintGemini: 'Key from aistudio.google.com. Gemini 2.5 Flash has a free tier.',
  ...
  profileHeroConnectedHint: 'Progress synced with the cloud',
  ...
  communityLikes: (n: number) => (n === 1 ? '1 like' : `${n} likes`),
  ...
  communityDisplayNameSave: 'Save name',
  communityDisplayNameSaved: 'Name saved',
