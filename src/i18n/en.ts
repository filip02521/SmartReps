...
export const en: Translation = {
  ...
  homeActivitySectionAria: 'Your activity — streak, weekly chain and metrics',
  homeCommunityTitle: 'Community',
  homeCommunitySectionAria: 'Community — weekly challenge and community plans',
  homeMoreTraining: 'More workouts',
  homeRowNewPlan: 'New plan',
  homeRowNewPlanHint: 'Build your own workout',
  homeRowProgramsHint: 'Enable another program',
  homeRowLibraryHint: 'Browse exercises',
  ...
  homeTipTitleWelcome: 'Welcome to SmartReps',
  homeTipWelcomeTraining: 'Program card below. Do a max test, pick a cycle, and start.',
  homeTipWelcomeProgress: 'Workout history, achievements, AI analysis and RPE trends.',
  homeTipWelcomePlans: 'Custom plans, ready-made programs and community.',
  homeTipWelcomeProfile: 'Account, sync, AI Coach and settings.',
  homeTipWelcomeHint: 'Navigate between sections using the bar at the bottom.',
  homeTipWelcomeCta: 'Start first workout',
  ...
  resumePromptBodyCustom: (planName: string, day: number, set: number, total: number) =>
    `${planName} · Day ${day} · set ${set}/${total}. Resume?`,
  resumePromptBodyFree: (exercises: number, sets: number) =>
    `Free workout · ${exercises} exercises · ${sets} sets. Resume?`,
  ...
  forecastRepsValue: (n: string) => `${n} reps`,
  ...
  workoutHint:
    'Set your result and press Done. "Exactly N" sets require exactly N.',
  ...
  testSquats: 'Squat test',
  testPrompt: 'How many reps will you do in one go at full range of motion?',
  testHowTo: 'Do your maximum reps without pausing. Use proper form — partial reps don\'t count.',
  ...
  warmupProgress: (done: number, total: number) => `${done}/${total} done`,
  ...
  onboardingSquatsDesc: 'From a max test to 300 squats — 15 cycles',
  onboardingReadyLine: 'Your plan is ready. Shall we start?',
  onboardingCloudRestoreFailed: 'Could not restore your data from the cloud',
  onboardingCloudRestoreFailedHint: 'Try again in Profile → Sync',
  onboardingCloudRestoreRetry: 'Retry',
  ...
  onboardingPickProgramHint: 'Pick at least one program to continue',
  ...
  errorActivateLevel: 'Failed to change level. Please try again.',
  ...
  techniqueSquatsTitle: 'Squat technique',
  techniqueSquatsStep1:
    'Feet shoulder-width apart, back straight, eyes forward.',
  techniqueSquatsStep2:
    'Lower hips down and back, as if sitting on a chair. Knees should not pass the toes.',
  techniqueSquatsStep3:
    'Stand up dynamically, extending hips and knees — full range without pausing at the bottom.',
  techniqueSquatsPoseStart: 'Start',
  techniqueSquatsPoseBottom: 'Bottom',
  techniqueSquatsPoseTop: 'Top',
  helpTechniqueSquats: 'Squat technique',
  ...
  seoTechniqueSquatsTitle: 'Squat technique',
  seoTechniqueSquatsDescription:
    'Proper squat technique — foot placement, knees, tempo and full range of motion. A guide for beginners.',
  ...
  streakAtRiskLoss: (weeks: number) =>
    `Skip this week and your ${weeks}-week streak is gone.`,
  streakAtRiskFreezeNote: 'Streak freeze can save it automatically.',
  streakChainAriaRisk: (current: number, best: number, days: number) =>
    `Streak at risk: ${current} weeks in a row, record: ${best} weeks, ${days} days left`,
  streakDaysShort: (days: number) => `${days}d`,
  streakHeroSaveRibbon: (weeks: number) =>
    `This workout saves your ${weeks}-week streak.`,
  ...
  streakFreezeAvailable: (count: number) =>
    count === 1 ? '1 freeze in reserve' : `${count} freezes in reserve`,
  streakFreezeAvailableNone: 'No freezes — a new one arrives each month',
  streakFreezeHowItWorks:
    'Skip a week? A freeze automatically saves your streak. You earn 1 per month, up to 3 in reserve.',
  streakFreezeCellTitle: (weekStart: string) => `Week ${weekStart}: frozen`,
  streakFreezeSavedToast: 'A streak freeze saved your streak!',
  streakFreezeLegend: 'Frozen',
  streakFreezeFreeHint: 'With SmartReps Pro your streak survives a skipped week — automatically.',
  // Profile titles — unlocked by achievements, selectable in Pro
  title_first_session: 'Novice',
  title_habit_3_in_14: 'Regular',
  title_first_custom_session: 'Own Path',
  title_first_squat: 'Squat Novice',
  title_first_publish: 'Creator',
  title_first_like: 'Appreciated',
  title_first_follower: 'Noticed',
  title_social_butterfly: 'Social Butterfly',
  title_first_review: 'Critic',
  title_weekend_warrior: 'Weekend Warrior',
  title_streak_4: 'In Rhythm',
  title_streak_12: 'Relentless',
  title_cycle_closed_strong: 'Closer',
  title_goal_pullups_30: 'Bar Hunter',
  title_pr_repeat_3: 'Record Breaker',
  title_workshop_custom: 'Architect',
  title_plan_with_legs: 'Steel Legs',
  title_both_programs: 'Dual Athlete',
  title_challenge_first: 'Challenger',
  title_habit_builder: 'Habit Builder',
  title_trainer_25: 'Trainer',
  title_speed_demon: 'Speed Demon',
  title_streak_26: 'Undying Flame',
  title_streak_52: 'Iron Will',
  title_sessions_100: 'Centurion',
  title_goal_pushups_100: 'Push-up Legend',
  title_goal_pullups_50: 'Pull-up Master',
  title_goal_squats_300: 'Squat King',
  title_volume_10k: 'Volume Titan',
  title_cycles_5: 'Cycle Pilgrim',
  title_poly_publisher: 'Catalog Master',
  title_challenge_winner: 'Champion',
  title_triple_threat: 'Triple Threat',
  title_pr_master: 'PR Master',
  title_cycle_master: 'Cycle Master',
  title_followed_by_25: 'Leader',
  title_community_pillar: 'Community Pillar',
  title_comeback_stronger: 'Legendary Comeback',
  title_legend_full_circle: 'Full Circle',
  title_legend_quiet_master: 'Quiet Master',
  title_legend_grandmaster: 'Grandmaster',
  title_legend_community: 'Community Legend',
  // Title picker UI
  profileTitleLabel: 'Profile title',
  profileTitleNone: 'No title',
  profileTitlePickTitle: 'Pick a title',
  profileTitlePickHint: 'Titles are unlocked by achievements — your pick shows on your public profile.',
  profileTitleUnlockedBy: (name: string) => `Earned via: ${name}`,
  ...
  profileTitleSaved: 'Title saved',
  profileTitleSaveError: "Couldn't save the title. Try again.",
  profileTitleProRequired: 'Profile titles require a Pro plan',
  ...
  muscleBalanceWeeklySets: (sets: string) => `${sets} sets/wk`,
  muscleBalanceWarningNamed: (groups: string) => `Undertrained: ${groups} — aim for a balanced plan.`,
  ...
  planEditNotFound: 'This plan no longer exists.',
  ...
  // ── Free workout (ad-hoc / empty workout) ──
  freeWorkoutTitle: 'Free workout',
  freeWorkoutHomeHint: 'Start from zero — add exercises as you go',
  freeWorkoutHeroBadge: 'No plan',
  freeWorkoutHeroHint: 'Empty workout — the clock is running, add exercises as you go',
  freeWorkoutStart: 'Start',
  freeWorkoutResume: 'Resume',
  freeWorkoutLoadError: 'Could not load the free workout. Please try again.',
  freeExerciseOptionsAria: 'Exercise options',
  freeSetsListAria: 'Logged sets',
  freeSetChipAria: (n: number, summary: string) => `Set ${n}: ${summary} — tap to edit`,
  freeRepsLabel: 'Reps',
  freeWeightLabel: (unit: string) => `Weight (${unit})`,
  freeDurationLabel: (unit: 'sec' | 'min') => (unit === 'min' ? 'Time (min)' : 'Time (sec)'),
  freeNextSetLabel: (n: number) => `Set ${n}`,
  freeSetLogged: (n: number, exerciseName: string) => `${exerciseName} — set ${n} logged`,
  freeUndoSet: 'Undo',
  freeLessValue: 'Decrease value',
  freeMoreValue: 'Increase value',
  freeLessWeight: 'Decrease weight',
  freeMoreWeight: 'Increase weight',
  freeHeaderStats: (exercises: number, sets: number) => `${exercises} ex · ${sets} sets`,
  freeMoveExerciseUp: 'Move up',
  freeMoveExerciseDown: 'Move down',
  freeRemoveExercise: 'Remove exercise',
  freeRemoveExerciseTitle: 'Remove exercise?',
  freeRemoveExerciseConfirm: 'This also removes its logged sets.',
  freeEmptyTitle: 'Starting from zero',
  freeEmptyHint: 'Add your first exercise — the workout clock is already running.',
  freeRecentExercises: 'Recently used',
  freeFinishWorkout: 'Finish',
  freeRestNextLabel: 'Rest — next set or exercise',
  freeFinishTitle: 'Finish workout?',
  freeFinishConfirm: (exercises: number, sets: number) =>
    `${exercises} exercises, ${sets} sets — the workout goes to history. You can save it as a plan afterwards.`,
  freeFinishEmptyConfirm: 'No sets logged — the workout will be discarded.',
  freeLeaveTitle: 'Leave workout?',
  freeLeaveDesc: 'The workout stays active — you can resume it from home.',
  freeLeaveEmptyDesc: 'No sets logged — the workout will be discarded.',
  freeLeaveAction: 'Leave',
  freeDiscardAction: 'Discard workout',
  freeEditSetTitle: (n: number) => `Set ${n}`,
  freeSaveSet: 'Save',
  freeSummaryTitle: 'Workout complete',
  freeStatDuration: 'Duration',
  freeStatExercisesSets: 'Exercises · sets',
  freeStatVolume: 'Volume',
  freeStatReps: 'Reps',
  freeSummaryExercises: 'Exercises performed',
  freeSavePlanTitle: 'Save as plan',
  freeSavePlanDesc: 'Keep this exercise-and-set structure as a reusable workout plan.',
  freeSavePlanSheetDesc: 'Name the plan — the values you logged become the set targets.',
  freeSaveAsPlan: 'Save as plan',
  freePlanNameLabel: 'Plan name',
  freePlanNamePlaceholder: 'e.g. Gym — chest and back',
  freePlanSaved: 'Plan saved — find it in Plans → Mine.',
  freePlanSavedTitle: 'Plan saved',
  freePlanSavedHint: 'You can now run it like any other workout plan.',
  freePlanSaveFailed: 'Could not save the plan. Please try again.',
  freeOpenPlan: 'Open My plans',
  ...
  bodyWeightDeleteConfirmTitle: 'Delete measurement?',
  bodyWeightDeleteConfirm: 'This weight entry will be permanently deleted.',
  ...
  progressRecordsEmptyHint: 'Complete your first workout to start tracking progress.',
  progressRecordsEmptyCta: 'Start training',
  ...
  programTierBeginner: 'Beginner',
  programTierIntermediate: 'Intermediate',
  programTierAdvanced: 'Advanced',
  programTierBeginnerDesc: 'Building foundations — from first reps',
  programTierIntermediateDesc: 'Developing strength and volume',
  programTierAdvancedDesc: 'Endurance and the road to the goal',
  programTierRepsRange: (min: number, max: number | null, unit: string) =>
    max === null ? `${min}+ ${unit}` : `${min}–${max} ${unit}`,
  programTierCyclesCount: (n: number) => (n === 1 ? '1 cycle' : `${n} cycles`),
  programTierYourTier: 'Your level',
  programTierLayout6day: '6-day',
  programTierLayout3day: '3-day',
  programTierLayout9day: '9-day',
  programActivateThisLevel: 'Activate this level',
  programEnableAndTest: 'Enable and take test',
  programDoMaxTest: 'Take max test',
  programRetest: 'Retest',
  programBackToCurrent: 'Back to current',
  programChangeToThisLevel: 'Switch to this level',
  programRecommendedForYou: 'Recommended for you',
  programBackToWorkout: 'Back to workout',
  planEstimatedWeeks: (min: number, max: number) => `~${min}–${max} wks`,
  ...
  resistanceBandsIntro:
    'If you can\'t do pull-ups on your own yet, you can start with a band-assisted variant.',
  ...
  resistanceBandsNote:
    'Treat the band variant as supplementary technical training alongside the main pull-up cycles.',
  ...
  celebrationSquats300: '300 squats goal achieved!',
  ...
  starterEmptyHint: 'Start from a ready template',
  starterEmptyHintDesc: 'Pick a proven plan matched to your level.',
  starterChipHint: 'Not sure where to start?',
  starterChipCta: 'Pick a template',
  starterSeeAll: 'See all templates',
  starterCategoryAll: 'All',
  starterCategoryHome: 'At home',
  starterCategoryGym: 'At the gym',
  starterCategoryCardio: 'Cardio',
  starterEmptyCategory: 'No templates in this category',
  starterDifficultyBeginner: 'Beginner',
  starterDifficultyIntermediate: 'Intermediate',
  starterDifficultyAdvanced: 'Advanced',
  starterDaysPerWeek: (n: number) => (n === 1 ? '1 day/wk' : `${n} days/wk`),
  starterEstimatedWeeks: (min: number, max: number) => `Cycle ~${min}–${max} wks`,
  starterEquipmentBodyweight: 'Bodyweight',
  starterEquipmentDumbbells: 'Dumbbells',
  starterEquipmentBarbell: 'Barbell',
  starterEquipmentFullGym: 'Full gym',
  starterEquipmentKettlebell: 'Kettlebell',
  starterPreview: 'Preview',
  starterActivate: 'Activate',
  starterActivating: 'Activating…',
  starterActivatedToast: (name: string) => `Activated plan “${name}”. You can start your workout.`,
  starterBadge: 'From template',
  starterPreviewTitle: 'Template preview',
  starterPreviewDayLabel: (n: number) => `Day ${n}`,
  starterPreviewProgression: (delta: number) => `Progression: +${delta} reps after cycle`,
  starterPreviewNoProgression: 'No auto-progression',
  starterPreviewExercisesCount: (n: number) => (n === 1 ? '1 exercise' : `${n} exercises`),
  starterPreviewSetsCount: (n: number) => (n === 1 ? '1 set' : `${n} sets`),
  starterPreviewRestLabel: 'Rest',
  starterPreviewStartHint: 'After activation, the plan appears in “My plans” and on the Training screen.',
  starterTemplateName_foundationBodyweight3d: 'Foundation Bodyweight',
  starterTemplateDesc_foundationBodyweight3d: 'Full body with no equipment. Pushups, squats, plank — build strength and movement patterns. 3 times a week.',
  starterTemplateName_calisthenicsStrength4d: 'Calisthenics Strength',
  starterTemplateDesc_calisthenicsStrength4d: 'Push/Pull/Legs/Core split for intermediates. Hypertrophy and calisthenics strength, 4 days a week.',
  starterTemplateName_pullupFoundations3d: 'Pullup Foundations',
  starterTemplateDesc_pullupFoundations3d: 'Path to your first pullup. Negatives, assisted and accessory work — 3 times a week with progression.',
  starterTemplateName_fullbodyDumbbell3d: 'Full Body Dumbbell',
  starterTemplateDesc_fullbodyDumbbell3d: 'Full-body strength with dumbbells. Learn loaded movement patterns, 3 complete sessions a week.',
  starterTemplateName_upperLowerBarbell4d: 'Upper/Lower Barbell',
  starterTemplateDesc_upperLowerBarbell4d: 'Classic upper/lower split with a barbell. Strength and hypertrophy, 4 days a week with load progression.',
  starterTemplateName_pushPullLegs6d: 'Push Pull Legs',
  starterTemplateDesc_pushPullLegs6d: 'Advanced PPL, 5 days a week. Maximum hypertrophy volume — 16–24 sets per muscle group weekly.',
  starterTemplateName_hiitExpress3d: 'HIIT Express',
  starterTemplateDesc_hiitExpress3d: 'Short, intense cardio sessions. Tabata, intervals and circuits — 3 times a week, 15–20 min.',
  starterTemplateName_coreConditioning3d: 'Core & Conditioning',
  starterTemplateDesc_coreConditioning3d: 'Strong core (anti-rotation, anti-extension) + conditioning. McGill-based, 3 times a week.',
  starterTemplateName_kettlebellPower3d: 'Kettlebell Power',
  starterTemplateDesc_kettlebellPower3d: 'Explosive power with a kettlebell. Swings, presses and squats — 3 days a week.',
  ...
  aiAnalysisEmptyCta: 'Start training',
  ...
  coachPostWorkoutLocalStreak: (count: number) => `${count === 1 ? '1 session' : `${count} sessions`} in a row with progress — consistency pays off. Keep it up!`,
  ...
  coachPlateauBody: (programLabel: string, sessionCount: number, lastValue: number, bestValue: number, sessionsSinceBest: number) =>
    `${programLabel}: ${sessionCount === 1 ? '1 session' : `${sessionCount} sessions`} without progress (last ${lastValue}, best ${bestValue}${sessionsSinceBest > 0 ? ` — ${sessionsSinceBest === 1 ? '1 session' : `${sessionsSinceBest} sessions`} ago` : ''}). Consider a deload (−40% volume) or a plan change.`,
  coachPlateauBodyRegression: (programLabel: string, sessionCount: number, lastValue: number, bestValue: number) =>
    `${programLabel}: ${sessionCount === 1 ? '1 session' : `${sessionCount} sessions`}, result dropped to ${lastValue} (best ${bestValue}). Regression usually means under-recovery — plan a deload (−40% volume) or an extra rest day.`,
  ...
  coachWeeklyReportSessions: (count: number, reps: number) => `${count === 1 ? '1 session' : `${count} sessions`}, ${reps} total reps.`,
  ...
  coachWeeklyReportTrainingDays: (days: number) => `${days === 1 ? '1 training day' : `${days} training days`}.`,
  ...
  coachWeeklyReportProgramEntry: (program: string, sessions: number, reps: number) => `${program}: ${sessions === 1 ? '1 session' : `${sessions} sessions`}, ${reps} reps.`,
  ...
  coachHistoryShowOlder: (n: number) => `Show older (${n})`,
  coachHistoryShowFewer: 'Collapse list',
  ...
  exerciseSortName: 'Name A-Z',
  exerciseSortRecent: 'Recently trained',
  exerciseSortSessions: 'Most sessions',
  ...
  challengeEndsInShort: (days: number) =>
    days <= 0 ? 'Ended' : days === 1 ? 'in 1 day' : `in ${days} days`,
  ...
  challengeLeaderboardGlobal: 'Global',
  challengeLeaderboardFollowing: 'Following',
  challengeLeaderboardFollowingEmpty: 'None of the people you follow have joined yet',
  challengeEnded: 'Challenge ended',
  challengeEndedHint: 'Results are closed. Check the final leaderboard!',
  challengeAutoTracked: 'Auto-tracked from your workouts',
  challengeRecommended: 'Recommended',
  challengeYourAverage: (n: number) => `Your average: ${n}/wk`,
  challengeYourBest: (n: number) => `Record to beat: ${n}`,
  challengeYourBestSet: (n: number) => `Your best set: ${n}`,
  challengeYourBestDay: (n: number) => `Your best day: ${n}`,
  challengeYourAvgSession: (n: number) => `Avg per workout: ${n}`,
  challengeYourAvgSets: (n: number) => `Avg: ${n} ${n === 1 ? 'set' : 'sets'}/wk`,
  challengeYourLastWeek: (n: number) => `Last week: ${n}`,
  challengeDifficultyEasy: 'Easy',
  challengeDifficultyChallenging: 'Just right',
  challengeDifficultyHard: 'Hard',
  challengeDifficultyUnknown: '—',
  challengeShowAll: (n: number) => `Show all (${n})`,
  challengeShowTop: 'Show recommended',
  challengeRecapTitle: 'Weekly challenges',
  challengeRecapAchieved: 'Challenge completed!',
  challengeRecapDone: 'Done',
  challengeRecapContributionReps: (n: number) => `+${n} reps from this workout`,
  challengeRecapContributionWorkoutTotal: (n: number) =>
    `This workout: ${n} ${n === 1 ? 'rep' : 'reps'}`,
  challengeRecapContributionSession: '+1 workout',
  challengeRecapContributionDay: '+1 day',
  challengeRecapContributionSets: (n: number) =>
    `+${n} ${n === 1 ? 'set' : 'sets'} from this workout`,
  challengeRecapContributionMet: 'Condition met!',
  challengeRecapContributionClockHalf: (part: 'early' | 'late') =>
    part === 'early' ? 'Morning covered (1/2)' : 'Evening covered (1/2)',
  challengeRecapContributionSurplus: (n: number) => `+${n} ${n === 1 ? 'rep' : 'reps'} above target`,
  challengeRecapContributionPrecision: 'Perfect form!',
  challengeRecapRemainingReps: (n: number) => `Only ${n} reps to go!`,
  challengeRecapRemainingSessions: (n: number) => `Only ${n} ${n === 1 ? 'workout' : 'workouts'} to go!`,
  challengeRecapRemainingDays: (n: number) => `Only ${n} ${n === 1 ? 'day' : 'days'} to go!`,
  challengeRecapRemainingSets: (n: number) => `Only ${n} ${n === 1 ? 'set' : 'sets'} to go!`,
  challengeAllAchieved: 'All challenges completed! Great job!',
  challengeAllAchievedHint: 'Check the leaderboard and wait for new challenges next week',
  challengeUrgent: 'Last chance!',
  challengeTypeVolume: 'Volume Master',
  challengeTypeConsistency: 'Iron Discipline',
  challengeTypePrecision: 'Perfect Form',
  challengeTypePersonalBest: 'Record Hunter',
  challengeTypeMarathon: 'Marathon',
  challengeTypeMaxSet: 'Power Set',
  challengeTypeGrinder: 'The Grinder',
  challengeTypeDaily: 'Daily Grind',
  challengeTypeEarlyBird: 'Early Bird',
  challengeTypeNightOwl: 'Night Owl',
  challengeTypeWeekend: 'Weekend Warrior',
  challengeTypeDouble: 'Double Up',
  challengeTypePerfectPair: 'Perfect Pair',
  challengeTypeImprovement: 'Progress Leap',
  challengeCatPower: 'Power & volume',
  challengeCatHabit: 'Rhythm & habit',
  challengeCatSkill: 'Precision',
  challengeCatRecords: 'Records',
  challengeDescVolume: 'Do as many reps as possible this week',
  challengeDescConsistency: (n: number) =>
    `Complete at least ${n === 1 ? '1 workout' : `${n} workouts`} this week`,
  challengeDescPrecision: 'Complete a workout with all sets passed',
  challengeDescPersonalBest: 'Beat your single-set rep record',
  challengeDescMarathon: (n: number) => `Do at least ${n} reps in a single workout`,
  challengeDescMaxSet: (n: number) => `Do at least ${n} reps in a single set`,
  challengeDescGrinder: (n: number) => `Complete ${n} total sets this week`,
  challengeDescDaily: (n: number) => `Train on at least ${n} different days this week`,
  challengeDescEarlyBird: 'Complete a workout that starts before 9:00 AM',
  challengeDescNightOwl: 'Complete a workout that starts at 8:00 PM or later',
  challengeDescWeekend: 'Complete a workout on Saturday or Sunday',
  challengeDescDouble: 'Complete two workouts on the same day',
  challengeDescPerfectPair: (n: number) =>
    `Complete ${n === 1 ? '1 workout' : `${n} workouts`} with all sets passed`,
  challengeDescImprovement: (n: number) => `Do at least ${n} more reps than last week`,
  challengeTypeSurplus: 'Bonus Reps',
  challengeTypeDominator: 'Dominator',
  challengeTypeStrongFinish: 'Strong Finish',
  challengeTypeSessionStarter: 'Strong Start',
  challengeTypeBigDay: 'Big Day',
  challengeTypeWeekdayQuest: 'Day Mission',
  challengeTypeMorningMoves: 'Morning Moves',
  challengeTypeLunchBreak: 'Lunch Break Workout',
  challengeTypeEveningShift: 'Evening Shift',
  challengeTypeAroundTheClock: 'Around the Clock',
  challengeTypeSundaySweat: 'Sunday Sweat',
  challengeTypeHatTrick: 'Hat-Trick',
  challengeTypeFlawlessSets: 'Flawless',
  challengeTypeSharpshooter: 'Sharpshooter',
  challengeTypeBounceBack: 'Bounce Back',
  challengeTypeMetronome: 'Metronome',
  challengeTypeVolumeRecord: 'Weekly Record',
  challengeTypeSessionRecord: 'Session Record',
  challengeTypeDayRecord: 'Day Record',
  challengeTypeBeatAverage: 'Above Average',
  ...
  challengeDescSurplus: (n: number) => `Do at least ${n} reps above your set targets`,
  challengeDescDominator: 'Do a set at 150% of its target or more',
  challengeDescStrongFinish: 'Finish a workout with a passed last set',
  challengeDescSessionStarter: 'Start a workout with a passed first set',
  challengeDescBigDay: (n: number) => `Do at least ${n} reps in a single day`,
  challengeDescWeekdayQuest: (day: string) => `Complete a workout ${day} this week`,
  challengeDescMorningMoves: 'Complete a workout started before 12:00',
  challengeDescLunchBreak: 'Complete a workout started between 11:00 and 14:00',
  challengeDescEveningShift: 'Complete a workout started between 18:00 and 22:00',
  challengeDescAroundTheClock: 'Complete a workout before 9:00 and one after 20:00',
  challengeDescSundaySweat: 'Complete a workout on Sunday',
  challengeDescHatTrick: (n: number) =>
    `Complete ${n === 1 ? '1 workout' : `${n} workouts`} with all sets passed`,
  challengeDescFlawlessSets: (n: number) =>
    `Do at least ${n === 1 ? '1 set' : `${n} sets`} at or above target`,
  challengeDescSharpshooter: 'Do a set with exactly the required number of reps',
  challengeDescBounceBack: 'After a failed set, pass a later one in the same workout',
  challengeDescMetronome: 'Complete a workout where sets differ by 2 reps at most',
  challengeDescVolumeRecord: 'Beat your record for weekly reps',
  challengeDescSessionRecord: 'Beat your record for reps in a single workout',
  challengeDescDayRecord: 'Beat your record for reps in a single day',
  challengeDescBeatAverage: 'Exceed your average weekly rep count',
  ...
  challengeProgressDays: (current: number, target: number) =>
    `${current} / ${target} ${target === 1 ? 'day' : 'days'}`,
  challengeProgressSets: (current: number, target: number) =>
    `${current} / ${target} ${target === 1 ? 'set' : 'sets'}`,
  ...
  communityTeaserLoadError: 'Failed to load suggestions.',
  ...
  achievement_goal_squats_300_title: 'Squat triple century',
  achievement_goal_squats_300_desc: '300 squats in a max test.',
  ...
  termsBody4:
    'Workout plans in the app were originally developed by SmartReps based on widely available calisthenics training methodology. SmartReps implements progress tracking.',
  termsBody5:
...
Return JSON in this format (this is an example, replace values):
{
  ...
  aiPromptPlanDurationLine: (min: number) => `- Session duration: ${min} min`,
...
Write in English. Be specific and encouraging.`,
  ...
  proFeatureUnlimitedPlans: 'Unlimited custom plans',
  ...
  proFeatureStreakFreeze: 'Streak freeze (skip a week safely)',
  proFeatureProfileTitle: 'Achievement profile titles',
  proPlanMonthly: 'Monthly',
  proPlanAnnual: 'Annual',
  proPlanLifetime: 'Lifetime',
  proPlanAnnualSavings: 'Save 67%',
  ...
  proPortalNoCustomer: 'No active subscription to manage.',
  ...
  proLimitStreakFreezeTitle: 'Streak freeze in Pro',
  proLimitStreakFreezeDesc: 'With Pro a skipped week never breaks your streak — a freeze is consumed automatically. You earn 1 per month, up to 3.',
  proLimitProfileTitleTitle: 'Profile titles in Pro',
  proLimitProfileTitleDesc: 'With Pro you can pick a title unlocked by your achievements — shown on your public profile.',
  proTeaserTitle: 'Pro feature',
  proTeaserDescription: 'This feature requires a Pro plan.',
  ...
  proRowStreakFreeze: 'Streak freeze',
  proRowProfileTitle: 'Achievement profile titles',
  ...
  proLaunchOfferNote:
    'Launch offer — the annual plan will soon cost $24.99. Buy now and keep the lower price forever.',
  proPerYear: '/ year',
  proPerMonth: '/ month',
  proOneTime: 'one-time',
