...
- Cykle pompki + podciąganie, trening programowy, postępy, PWA, OTP login, sync Supabase
...
- Własne plany: poniżej celu = dzień i tak zaliczony (miękka wzmianka na summary); programy wbudowane = fail → restart od dnia 1
- Marka PL-first, privacy/terms

## Poza scope (na razie)

- Angielski i18n, gotowe programy curated (np. przysiady w katalogu builtin), feed / komentarze / follow / rankingi osób, AI dobór planu, CRDT mid-workout
